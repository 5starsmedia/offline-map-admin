...
class NewsEditCategoryCtrl {
  /*@ngInject*/
  constructor($scope, item, $state, NewsRegionModel, $modal, notify, $filter, postType) {
    $scope.item = item;
    ...
    $scope.$watch('tree', function(tree) {
      ...
      var parents = [], editedItem = NewsRegionModel.find(tree, function (item) {
